...
namespace LocalDatabase.Local
{
    public class GetLocalRecordDetails
    {
        public string GetRegion(UpdateMessage message)
        {
            ...
            {
                Region record = (from x in context.Regions where x.Id == message.LocalId select x).First();
        ...
        public string GetEmployeeStatus(UpdateMessage message)
        {
            ...
            using (var context = new LocalParkInspectEntities())
            {
                EmployeeStatu record = (from x in context.EmployeeStatus where x.Id == message.LocalId select x).First();
        ...
        public string GetEmployee(UpdateMessage message)
        {
            ...
            using (var context = new LocalParkInspectEntities())
            {
                Employee record = (from x in context.Employees where x.Id == message.LocalId select x).First();
        ...
        public string GetAccount(UpdateMessage message)
        {
            ...
            using (var context = new LocalParkInspectEntities())
            {
                Account record = (from x in context.Accounts where x.Id == message.LocalId select x).First();
        ...
        public string GetAvailability(UpdateMessage message)
        {
            ...
            using (var context = new LocalParkInspectEntities())
            {
                Availability record = (from x in context.Availabilities where x.EmployeeId == message.LocalId select x).Where(x => x.Date == message.LocalId_DateTime).First();
        ...
        public string GetWorkingHours(UpdateMessage message)
        {
            ...
            using (var context = new LocalParkInspectEntities())
            {
                WorkingHour record = (from x in context.WorkingHours where x.EmployeeId == message.LocalId select x).Where(x => x.Date == message.LocalId_DateTime).First();
        ...
        public string GetCustomer(UpdateMessage message)
        {
            ...
            using (var context = new LocalParkInspectEntities())
            {
                Customer record = (from x in context.Customers where x.Id == message.LocalId select x).First();
        ...
        public string GetAssignment(UpdateMessage message)
        {
            ...
            using (var context = new LocalParkInspectEntities())
            {
                Assignment record = (from x in context.Assignments where x.Id == message.LocalId select x).First();
        ...
        public string GetInspectionStatus(UpdateMessage message)
        {
            ...
            using (var context = new LocalParkInspectEntities())
            {
                InspectionStatu record = (from x in context.InspectionStatus where x.Id == message.LocalId select x).First();
        ...
        public string GetInspection(UpdateMessage message)
        {
            ...
            using (var context = new LocalParkInspectEntities())
            {
                Inspection record = (from x in context.Inspections where x.Id == message.LocalId select x).First();
        ...
        public string GetInspectionImage(UpdateMessage message)
        {
            ...
            using (var context = new LocalParkInspectEntities())
            {
                InspectionImage record = (from x in context.InspectionImages where x.Id == message.LocalId select x).First();
        ...
        public string GetKeywordCategory(UpdateMessage message)
        {
            ...
            using (var context = new LocalParkInspectEntities())
            {
                KeywordCategory record = (from x in context.KeywordCategories where x.Id == message.LocalId select x).First();
        ...
        public string GetKeyword(UpdateMessage message)
        {
            ...
            using (var context = new LocalParkInspectEntities())
            {
                Keyword record = (from x in context.Keywords where x.Id == message.LocalId select x).First();
        ...
        public string GetModule(UpdateMessage message)
        {
            ...
            using (var context = new LocalParkInspectEntities())
            {
                Module record = (from x in context.Modules where x.Id == message.LocalId select x).First();
        ...
        public string GetQuestionSort(UpdateMessage message)
        {
            ...
            using (var context = new LocalParkInspectEntities())
            {
                QuestionSort record = (from x in context.QuestionSorts where x.Id == message.LocalId select x).First();
        ...
        public string GetQuestion(UpdateMessage message)
        {
            ...
            using (var context = new LocalParkInspectEntities())
            {
                Question record = (from x in context.Questions where x.Id == message.LocalId select x).First();
        ...
        public string GetQuestionaire(UpdateMessage message)
        {
            ...
            using (var context = new LocalParkInspectEntities())
            {
                Questionaire record = (from x in context.Questionaires where x.Id == message.LocalId select x).First();
        ...
        public string GetQuestionAnswer(UpdateMessage message)
        {
            ...
            using (var context = new LocalParkInspectEntities())
            {
                QuestionAnswer record = (from x in context.QuestionAnswers where x.QuestionnaireId == message.LocalId select x).Where(x => x.QuestionId == message.LocalId_Extra).First();
        ...
        public string GetQuestionaireModule(UpdateMessage message)
        {
            ...
            using (var context = new LocalParkInspectEntities())
            {
                QuestionaireModule record = (from x in context.QuestionaireModules where x.QuestionaireId == message.LocalId select x).Where(x => x.ModuleId == message.LocalId_Extra).First();
        ...
        public string GetQuestionKeyword(UpdateMessage message)
        {
            ...
            using (var context = new LocalParkInspectEntities())
            {
                QuestionKeyword record = (from x in context.QuestionKeywords where x.QuestionId == message.LocalId select x).Where(x => x.KeywordId == message.LocalId_Extra).First();
