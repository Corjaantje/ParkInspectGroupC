    ...
    public class SaveToCentral
    {
        ...
        private int GetInspectionId(int i)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                ...
                ParkInspectGroupC.DOMAIN.Inspection r = context.Inspection.Where(x => x.DateCreated == lastDateAdded).First();
                id = r.Id;
            }
            return id;
        }
        ...
        private int GetQuestionSortId(int i)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                ...
                ParkInspectGroupC.DOMAIN.QuestionSort r = context.QuestionSort.Where(x => x.DateCreated == lastDateAdded).First();
                id = r.Id;
            }
            return id;
        }
        private int GetQuestionnaireId(int i)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                ...
                ParkInspectGroupC.DOMAIN.Questionnaire r = context.Questionnaire.Where(x => x.DateCreated == lastDateAdded).First();
                id = r.Id;
            }
            return id;
        }
        private int GetQuestionId(int i)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                ...
                ParkInspectGroupC.DOMAIN.Question r = context.Question.Where(x => x.DateCreated == lastDateAdded).First();
                id = r.Id;
            }
            return id;
        }
        private int GetModuleId(int i)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                ...
                ParkInspectGroupC.DOMAIN.Module r = context.Module.Where(x => x.DateCreated == lastDateAdded).First();
                id = r.Id;
            }
            return id;
        }
