                ...
                if (list.Count > 0)
                {
                    using (var context = new ParkInspectEntities())
                    {
                        foreach (Domain.Availability r in list)
                        {
                            ...
                            ParkInspectGroupC.DOMAIN.Availability central = (from x in context.Availability where x.EmployeeId == _id select x).Where(x => (x.Date == _date)).First();
                ...
                if (list.Count > 0)
                {
                    using (var context = new ParkInspectEntities())
                    {
                        foreach (Domain.WorkingHours r in list)
                        {
                            int _id = Convert.ToInt32(r.EmployeeId);
                            DateTime _date = r.Date;
                            ParkInspectGroupC.DOMAIN.WorkingHours central = (from x in context.WorkingHours where x.EmployeeId == _id select x).Where(x => (x.Date == _date)).First();
            ...
            try
            {
                ...
                if (list.Count > 0)
                {
                    using (var context = new ParkInspectEntities())
                    {
                        ...
                        {
                            int _id = Convert.ToInt32(r.Id);
                            ParkInspectGroupC.DOMAIN.Inspection central = (from x in context.Inspection where x.Id == _id select x).First();
            ...
            try
            {
                ...
                if (list.Count > 0)
                {
                    using (var context = new ParkInspectEntities())
                    {
                        ...
                        {
                            int _id = Convert.ToInt32(r.Id);
                            ParkInspectGroupC.DOMAIN.Coordinate central = (from x in context.Coordinate where x.Id == _id select x).First();
            ...
            try
            {
                ...
                if (list.Count > 0)
                {
                    using (var context = new ParkInspectEntities())
                    {
                        ...
                        {
                            int _id = Convert.ToInt32(r.Id);
                            ParkInspectGroupC.DOMAIN.Module central = (from x in context.Module where x.Id == _id select x).First();
            ...
            try
            {
                ...
                if (list.Count > 0)
                {
                    using (var context = new ParkInspectEntities())
                    {
                        ...
                        {
                            int _id = Convert.ToInt32(r.Id);
                            ParkInspectGroupC.DOMAIN.QuestionSort central = (from x in context.QuestionSort where x.Id == _id select x).First();
            ...
            try
            {
                ...
                if (list.Count > 0)
                {
                    using (var context = new ParkInspectEntities())
                    {
                        ...
                        {
                            int _id = Convert.ToInt32(r.Id);
                            ParkInspectGroupC.DOMAIN.Question central = (from x in context.Question where x.Id == _id select x).First();
            ...
            try
            {
                ...
                if (list.Count > 0)
                {
                    using (var context = new ParkInspectEntities())
                    {
                        ...
                        {
                            int _id = Convert.ToInt32(r.Id);
                            ParkInspectGroupC.DOMAIN.Questionnaire central = (from x in context.Questionnaire where x.Id == _id select x).First();
