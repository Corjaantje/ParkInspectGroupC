    ...
    public class CreateSQLiteDatabase
    {
        public bool Create(DatabaseActions _sqliteActions, string dbName, bool sync)
        {
            ...
            if (createdbfile || sync)
            {
                ...
                var _connection = new SQLiteConnection("Data Source=" + dbName + ".sqlite;Version=3;");
        ...
        {
            var sql = "CREATE TABLE EmployeeStatus (" +
                      "Id INTEGER PRIMARY KEY NOT NULL," +
        ...
        {
            var sql = "CREATE TABLE Availability (" +
                      "EmployeeId INTEGER NOT NULL," +
                      "Date DATE NOT NULL," +
        ...
        {
            var sql = "CREATE TABLE WorkingHours (" +
                      "EmployeeId INTEGER NOT NULL," +
                      "Date DATE NOT NULL," +
                      "StartTime TIME(0) NULL," +
                      "EndTime TIME(0) NULL," +
        ...
        {
            var sql = "CREATE TABLE Assignment (" +
                      "Id INTEGER PRIMARY KEY NOT NULL, " +
        ...
        {
            var sql = "CREATE TABLE InspectionStatus (" +
                      "Id INTEGER PRIMARY KEY NOT NULL, " +
        ...
        {
            var sql = "CREATE TABLE Inspection (" +
                      "Id INTEGER PRIMARY KEY NOT NULL," +
        ...
        {
            var sql = "CREATE TABLE Coordinate (" +
                      "Id INTEGER PRIMARY KEY NOT NULL," +
        ...
        {
            var sql = "CREATE TABLE InspectionImage (" +
                      "Id INTEGER PRIMARY KEY NOT NULL," +
        ...
        {
            var sql = "CREATE TABLE QuestionSort (" +
                      "Id INTEGER PRIMARY KEY NOT NULL, " +
                      "Description VARCHAR(255) NOT NULL," +
                      "DateCreated datetime DEFAULT CURRENT_TIMESTAMP NOT NULL," +
                      "DateUpdated datetime DEFAULT CURRENT_TIMESTAMP NOT NULL," +
        ...
        {
            var sql = "CREATE TABLE QuestionAnswer (" +
        ...
        {
            var sql = "CREATE TABLE Questionaire (" +
                      "Id INTEGER PRIMARY KEY NOT NULL," +
        ...
        {
            var sql = "CREATE TABLE QuestionaireModule (" +
        ...
        {
            var sql = "CREATE TABLE QuestionKeyword (" +
                      "QuestionId INTEGER NOT NULL, " +
        ...
        {
            var sql = "CREATE TABLE KeywordCategory (" +
                      "Id INTEGER PRIMARY KEY NOT NULL," +
                      "Description VARCHAR(255) NOT NULL," +
                      "DateCreated datetime DEFAULT CURRENT_TIMESTAMP NOT NULL," +
                      "DateUpdated datetime DEFAULT CURRENT_TIMESTAMP NOT NULL," +
