...
namespace LocalDatabase.Central
{
    public class GetCentralRecordDetails
    {
        ...
        public string GetAvailability(UpdateMessage message)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                ParkInspectGroupC.DOMAIN.Availability record = (from x in context.Availability where x.EmployeeId == message.CentralId select x).Where(x => x.Date == message.CentralId_DateTime).First();
        ...
        public string GetWorkingHours(UpdateMessage message)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                ParkInspectGroupC.DOMAIN.WorkingHours record = (from x in context.WorkingHours where x.EmployeeId == message.CentralId select x).Where(x => x.Date == message.CentralId_DateTime).First();
        ...
        public string GetInspection(UpdateMessage message)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                ParkInspectGroupC.DOMAIN.Inspection record = (from x in context.Inspection where x.Id == message.CentralId select x).First();
        ...
        public string GetCoordinate(UpdateMessage message)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                ParkInspectGroupC.DOMAIN.Coordinate record = (from x in context.Coordinate where x.Id == message.CentralId select x).First();
        ...
        public string GetModule(UpdateMessage message)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                ParkInspectGroupC.DOMAIN.Module record = (from x in context.Module where x.Id == message.CentralId select x).First();
        ...
        public string GetQuestionSort(UpdateMessage message)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                ParkInspectGroupC.DOMAIN.QuestionSort record = (from x in context.QuestionSort where x.Id == message.CentralId select x).First();
        ...
        public string GetQuestion(UpdateMessage message)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                ParkInspectGroupC.DOMAIN.Question record = (from x in context.Question where x.Id == message.CentralId select x).First();
        ...
        public string GetQuestionaire(UpdateMessage message)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                ParkInspectGroupC.DOMAIN.Questionnaire record = (from x in context.Questionnaire where x.Id == message.CentralId select x).First();
