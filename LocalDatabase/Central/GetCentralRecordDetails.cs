...
namespace LocalDatabase.Central
{
    public class GetCentralRecordDetails
    {
        public string GetRegion(UpdateMessage message)
        {
            ...
            {
                var record = (from x in context.Region where x.Id == message.CentralId select x).First();
        ...
        public string GetEmployeeStatus(UpdateMessage message)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                var record = (from x in context.EmployeeStatus where x.Id == message.CentralId select x).First();
        ...
        public string GetEmployee(UpdateMessage message)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                var record = (from x in context.Employee where x.Id == message.CentralId select x).First();
        ...
        public string GetAccount(UpdateMessage message)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                var record = (from x in context.Account where x.Id == message.CentralId select x).First();
        ...
        public string GetAvailability(UpdateMessage message)
        {
            ...
            {
                var record =
                    (from x in context.Availability where x.EmployeeId == message.CentralId select x).Where(
                        x => x.Date == message.CentralId_DateTime).First();
        ...
        public string GetWorkingHours(UpdateMessage message)
        {
            ...
            {
                var record =
                    (from x in context.WorkingHours where x.EmployeeId == message.CentralId select x).Where(
                        x => x.Date == message.CentralId_DateTime).First();
        ...
        public string GetCustomer(UpdateMessage message)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                var record = (from x in context.Customer where x.Id == message.CentralId select x).First();
        ...
        public string GetAssignment(UpdateMessage message)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                var record = (from x in context.Assignment where x.Id == message.CentralId select x).First();
        ...
        public string GetInspectionStatus(UpdateMessage message)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                var record = (from x in context.InspectionStatus where x.Id == message.CentralId select x).First();
        ...
        public string GetInspection(UpdateMessage message)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                var record = (from x in context.Inspection where x.Id == message.CentralId select x).First();
        ...
        public string GetCoordinate(UpdateMessage message)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                var record = (from x in context.Coordinate where x.Id == message.CentralId select x).First();
        ...
        public string GetInspectionImage(UpdateMessage message)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                var record = (from x in context.InspectionImage where x.Id == message.CentralId select x).First();
        ...
        public string GetKeywordCategory(UpdateMessage message)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                var record = (from x in context.KeywordCategory where x.Id == message.CentralId select x).First();
        ...
        public string GetKeyword(UpdateMessage message)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                var record = (from x in context.Keyword where x.Id == message.CentralId select x).First();
        ...
        public string GetModule(UpdateMessage message)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                var record = (from x in context.Module where x.Id == message.CentralId select x).First();
        ...
        public string GetQuestionSort(UpdateMessage message)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                var record = (from x in context.QuestionSort where x.Id == message.CentralId select x).First();
        ...
        public string GetQuestion(UpdateMessage message)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                var record = (from x in context.Question where x.Id == message.CentralId select x).First();
        ...
        public string GetQuestionaire(UpdateMessage message)
        {
            ...
            using (var context = new ParkInspectEntities())
            {
                var record = (from x in context.Questionnaire where x.Id == message.CentralId select x).First();
        ...
        public string GetQuestionAnswer(UpdateMessage message)
        {
            ...
            {
                var record =
                    (from x in context.QuestionAnswer where x.QuestionnaireId == message.CentralId select x).Where(
                        x => x.QuestionId == message.CentralId_Extra).First();
        ...
        public string GetQuestionaireModule(UpdateMessage message)
        {
            ...
            {
                var record =
                    (from x in context.QuestionnaireModule where x.QuestionnaireId == message.CentralId select x).Where(
                        x => x.ModuleId == message.CentralId_Extra).First();

                msg = "Module: " + record.Module.Name + Environment.NewLine +
                      "Questionnaire nummer: " + record.QuestionnaireId;
            }
        ...
        public string GetQuestionKeyword(UpdateMessage message)
        {
            ...
            {
                var record =
                    (from x in context.QuestionKeyword where x.QuestionId == message.CentralId select x).Where(
                        x => x.KeywordId == message.CentralId_Extra).First();
