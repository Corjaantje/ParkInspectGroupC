    ...
    public class GetFromCentral
    {
            ...
            try
            {
                ...
                using (var localContext = new LocalParkInspectEntities())
                {
                    foreach (ParkInspectGroupC.DOMAIN.Employee r in list)
                    {
                        ...
                        localContext.Employees.Add(_new);
                    }
                    localContext.SaveChanges();
                }
            ...
            try
            {
                ...
                using (var localContext = new LocalParkInspectEntities())
                {
                    foreach (ParkInspectGroupC.DOMAIN.Account r in list)
                    {
                        ...
                        localContext.Accounts.Add(_new);
                    }
                    localContext.SaveChanges();
                }
        ...
        private bool GetAvailability()
        {
            ...
            try
            {
                using (var context = new ParkInspectEntities())
                {
                    foreach (ParkInspectGroupC.DOMAIN.Availability r in context.Availabilities)
                    {
                        list.Add(r);
                    }
                }
                ...
                using (var localContext = new LocalParkInspectEntities())
                {
                    foreach (ParkInspectGroupC.DOMAIN.Availability r in list)
                    {
                        ...
                        localContext.Availabilities.Add(_new);
                    }
                    localContext.SaveChanges();
                }
        ...
        {
            List<ParkInspectGroupC.DOMAIN.WorkingHour> list = new List<ParkInspectGroupC.DOMAIN.WorkingHour>();

            try
            {
                using (var context = new ParkInspectEntities())
                {
                    foreach (ParkInspectGroupC.DOMAIN.WorkingHour r in context.WorkingHours)
                    {
                        list.Add(r);
                    }
                }
                ...
                using (var localContext = new LocalParkInspectEntities())
                {
                    foreach (ParkInspectGroupC.DOMAIN.WorkingHour r in list)
                    {
                        Domain.WorkingHour _new = new Domain.WorkingHour();
                        _new.EmployeeId = r.EmployeeId;
                        _new.Date = r.Date;
                        _new.StartTime = Convert.ToDateTime(r.StartTime.ToString());
                        _new.EndTime = Convert.ToDateTime(r.EndTime.ToString());
            ...
            try
            {
                ...
                using (var localContext = new LocalParkInspectEntities())
                {
                    foreach (ParkInspectGroupC.DOMAIN.Customer r in list)
                    {
                        ...
                        localContext.Customers.Add(_new);
                    }
                    localContext.SaveChanges();
                }
            ...
            try
            {
                ...
                using (var localContext = new LocalParkInspectEntities())
                {
                    foreach (ParkInspectGroupC.DOMAIN.Assignment r in list)
                    {
                        ...
                        localContext.Assignments.Add(_new);
                    }
                    localContext.SaveChanges();
                }
        ...
        private bool GetInspection()
        {
            ...
            try
            {
                using (var context = new ParkInspectEntities())
                {
                    foreach (ParkInspectGroupC.DOMAIN.Inspection r in context.Inspections)
                    {
                        list.Add(r);
                    }
                }
                ...
                using (var localContext = new LocalParkInspectEntities())
                {
                    foreach (ParkInspectGroupC.DOMAIN.Inspection r in list)
                    {
                        ...
                        localContext.Inspections.Add(_new);
                    }
                    localContext.SaveChanges();
                }
            ...
            try
            {
                ...
                using (var localContext = new LocalParkInspectEntities())
                {
                    foreach (ParkInspectGroupC.DOMAIN.KeywordCategory r in list)
                    {
                        ...
                        localContext.KeywordCategories.Add(_new);
                    }
                    localContext.SaveChanges();
                }
            ...
            try
            {
                ...
                using (var localContext = new LocalParkInspectEntities())
                {
                    foreach (ParkInspectGroupC.DOMAIN.Keyword r in list)
                    {
                        ...
                        localContext.Keywords.Add(_new);
                    }
                    localContext.SaveChanges();
                }
        ...
        private bool GetModule()
        {
            ...
            try
            {
                using (var context = new ParkInspectEntities())
                {
                    foreach (ParkInspectGroupC.DOMAIN.Module r in context.Modules)
                    {
                        list.Add(r);
                    }
                }
        ...
        private bool GetQuestionSort()
        {
            ...
            try
            {
                using (var context = new ParkInspectEntities())
                {
                    foreach (ParkInspectGroupC.DOMAIN.QuestionSort r in context.QuestionSorts)
                    {
                        list.Add(r);
                    }
                }
                ...
                using (var localContext = new LocalParkInspectEntities())
                {
                    foreach (ParkInspectGroupC.DOMAIN.QuestionSort r in list)
                    {
                        ...
                        localContext.QuestionSorts.Add(_new);
                    }
                    localContext.SaveChanges();
                }
        ...
        private bool GetQuestion()
        {
            ...
            try
            {
                using (var context = new ParkInspectEntities())
                {
                    foreach (ParkInspectGroupC.DOMAIN.Question r in context.Questions)
                    {
                        list.Add(r);
                    }
                }
                ...
                using (var localContext = new LocalParkInspectEntities())
                {
                    foreach (ParkInspectGroupC.DOMAIN.Question r in list)
                    {
                        ...
                        localContext.Questions.Add(_new);
                    }
                    localContext.SaveChanges();
                }
        ...
        private bool GetQuestionaire()
        {
            ...
            try
            {
                using (var context = new ParkInspectEntities())
                {
                    foreach (ParkInspectGroupC.DOMAIN.Questionnaire r in context.Questionnaires)
                    {
                        list.Add(r);
                    }
                }
                ...
                using (var localContext = new LocalParkInspectEntities())
                {
                    foreach (ParkInspectGroupC.DOMAIN.Questionnaire r in list)
                    {
                        ...
                        localContext.Questionaires.Add(_new);
                    }
                    localContext.SaveChanges();
                }
            ...
            try
            {
                ...
                using (var localContext = new LocalParkInspectEntities())
                {
                    foreach (ParkInspectGroupC.DOMAIN.QuestionAnswer r in list)
                    {
                        ...
                        localContext.QuestionAnswers.Add(_new);
                    }
                    localContext.SaveChanges();
                }
            ...
            try
            {
                ...
                using (var localContext = new LocalParkInspectEntities())
                {
                    foreach (ParkInspectGroupC.DOMAIN.QuestionnaireModule r in list)
                    {
                        ...
                        localContext.QuestionaireModules.Add(_new);
                    }
                    localContext.SaveChanges();
                }
            ...
            try
            {
                ...
                using (var localContext = new LocalParkInspectEntities())
                {
                    foreach (ParkInspectGroupC.DOMAIN.QuestionKeyword r in list)
                    {
                        ...
                        localContext.QuestionKeywords.Add(_new);
                    }
                    localContext.SaveChanges();
                }
